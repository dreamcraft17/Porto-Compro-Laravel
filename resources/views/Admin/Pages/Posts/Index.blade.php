...
@section('Pages')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="/admin/informasi/create" class="badge bg-success"><span data-feather="plus"></span></a>
    </div>
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="/admin/informasi/{{ $post->slug }}" class="badge bg-info"><span
                                    data-feather="eye"></span></a>
                            <a href="/admin/informasi/{{ $post->slug }}/edit" class="badge bg-warning"><span
