                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('careers.update', $career->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $career->name }}" required autofocus>
                                </div>
                            </div>
</br>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="message" class="form-control" name="detail" required>{{ $career->detail }}</textarea>
                                </div>
                            </div>
                            </br>
                            <div class="form-group row">
